describe("Transformations", function() {
    ...
    var aabb = Physics.aabb(0, 0, 50, 30)
        ...
        ,T = Physics.transform().rotate(Math.PI/2).translate(Physics.vector({ x: 70, y: 70 }))
        ;
    ...
    it("should rotate vectors correctly about different origin", function(){
        ...
        v = Physics.vector(5, 3);
        T.toIdentity().rotate( -Math.PI/2, Physics.vector(2, 2) );
        T.T( v );
    ...
    //
    //     T.toIdentity();
    //     T.rotate( 3, Physics.vector({ x: 3, y: 5 }) );
    //     T.translate(Physics.vector({ x: -3, y: -7 }));
    //
